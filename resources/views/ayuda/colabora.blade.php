...
<div class="container mt-4">
    ...
    <div class="alert-warning p-4">
        <p>Este sitio se encuentra realizado en Laravel y liberado todo su código en GitHub.</p> 
        <p> Para clonarlo o realizar mejoras, hacé clic <a href="https://github.com/Hugob79/biblioteca-enlace-libre.git" target="_blank">acá</a> </p>
